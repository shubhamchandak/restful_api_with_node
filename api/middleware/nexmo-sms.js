    ...
    sendConfirmationSms: (orderId) => {
        ...
        .then(orderDetail => {
            ...
            let opts = {
                ...
                "sms": [
                {
                    "message": "Your order from CherryBrooklyn amounted Rs." + orderDetail.order.finalAmount + " has been placed successfully and will be delivered soon. For realtime updates on your order, reach to our delivery executive at " + process.env.CONTACT_DELIVERY,
